  ...
  <table class="table table-hover" id="myTable">
    ...
    {foreach($faq as $k=>$v) { 
      if ($faq[$k]['parentId'] == "0") $nameparent = ""; 
        ...
        $sql = "SELECT name from cat where id like '".$faq[$k]['parentId']."'";
      ...
      <tr>
       ...
       <td><a href="editcategory.php?id=<?php echo base64_encode($faq[$k]['id']);?>"><button class=" btn btn-primary btn-warning" >Edit<i class="fa fa-pencil" aria-hidden="true"></i></button></a>
        <td><a href="deletecategory.php?id=<?php echo base64_encode($faq[$k]['id']);?>" class="btn btn-social-icon btn-google" onClick="return checkDelete()" ><i class="fa fa fa-trash-o"></i></a>
