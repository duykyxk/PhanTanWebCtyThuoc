...
}if (property_exists($data,"image16")){
 $image16= $data->image16; $dem=$dem+1; }
if (property_exists($data,"image17")){
 $image17= $data->image17; $dem=$dem+1; }
if (property_exists($data,"image18")){ 
	$image18= $data->image18; $dem=$dem+1; }
if (property_exists($data,"image19")){ 
	$image19= $data->image19; $dem=$dem+1; }
if (property_exists($data,"image20")){ 
	$image20= $data->image20; $dem=$dem+1; }
if (property_exists($data,"image21")){ 
	$image21= $data->image21; $dem=$dem+1; }
if (property_exists($data,"image22")){ 
	$image22= $data->image22; $dem=$dem+1; }
if (property_exists($data,"image23")){ 
	$image23= $data->image23; $dem=$dem+1; }
if (property_exists($data,"image24")){ 
	$image24= $data->image24; $dem=$dem+1; }
if (property_exists($data,"image25")){ 
	$image25= $data->image25; $dem=$dem+1; }
if (property_exists($data,"image26")){ 
	$image26= $data->image26; $dem=$dem+1; }
if (property_exists($data,"image27")){ 
	$image27= $data->image27; $dem=$dem+1; }
if (property_exists($data,"image28")){ 
	$image28= $data->image28; $dem=$dem+1; }
if (property_exists($data,"image29")){ 
	$image29= $data->image29; $dem=$dem+1; }
if (property_exists($data,"image30")){ 
	$image30= $data->image30; $dem=$dem+1; }
if (property_exists($data,"image31")){ 
	$image31= $data->image31; $dem=$dem+1; }
if (property_exists($data,"image32")){ 
	$image32= $data->image32; $dem=$dem+1; }
if (property_exists($data,"image33")){ 
	$image33= $data->image33; $dem=$dem+1; }
if (property_exists($data,"image34")){ 
	$image34= $data->image34; $dem=$dem+1; }
if (property_exists($data,"image35")){ 
	$image35= $data->image35; $dem=$dem+1; }
if (property_exists($data,"image36")){ 
	$image36= $data->image36; $dem=$dem+1; }
if (property_exists($data,"image37")){ 
	$image37= $data->image37; $dem=$dem+1; }
if (property_exists($data,"image38")){ 
	$image38= $data->image38; $dem=$dem+1; }
if (property_exists($data,"image39")){ 
	$image39= $data->image39; $dem=$dem+1; }
if (property_exists($data,"image40")){ 
	$image40= $data->image40; $dem=$dem+1; }
if (property_exists($data,"image41")){ 
	$image41= $data->image41; $dem=$dem+1; }
if (property_exists($data,"image42")){ 
	$image42= $data->image42; $dem=$dem+1; }
if (property_exists($data,"image43")){ 
	$image43= $data->image43; $dem=$dem+1; }
if (property_exists($data,"image44")){ 
	$image44= $data->image44; $dem=$dem+1; }
if (property_exists($data,"image45")){ 
	$image45= $data->image45; $dem=$dem+1; }
if (property_exists($data,"image46")){ 
	$image46= $data->image46; $dem=$dem+1; }
if (property_exists($data,"image47")){ 
	$image47= $data->image47; $dem=$dem+1; }
if (property_exists($data,"image48")){ 
	$image48= $data->image48; $dem=$dem+1; }
if (property_exists($data,"image49")){ 
	$image49= $data->image49; $dem=$dem+1; }
if (property_exists($data,"image50")){ 
	$image50= $data->image50; $dem=$dem+1; }
if (property_exists($data,"image51")){ 
	$image51= $data->image51; $dem=$dem+1; }
if (property_exists($data,"image52")){ 
	$image52= $data->image52; $dem=$dem+1; }
if (property_exists($data,"image53")){ 
	$image53= $data->image53; $dem=$dem+1; }
if (property_exists($data,"image54")){ 
	$image54= $data->image54; $dem=$dem+1; }
if (property_exists($data,"image55")){ 
	$image55= $data->image55; $dem=$dem+1; }
if (property_exists($data,"image56")){ 
	$image56= $data->image56; $dem=$dem+1; }
if (property_exists($data,"image57")){ 
	$image57= $data->image57; $dem=$dem+1; }
if (property_exists($data,"image58")){ 
	$image58= $data->image58; $dem=$dem+1; }
if (property_exists($data,"image59")){ 
	$image59= $data->image59; $dem=$dem+1; }
if (property_exists($data,"image60")){ 
	$image60= $data->image60; $dem=$dem+1; }
if (property_exists($data,"image61")){ 
	$image61= $data->image61; $dem=$dem+1; }
if (property_exists($data,"image62")){ 
	$image62= $data->image62; $dem=$dem+1; }
if (property_exists($data,"image63")){ 
	$image63= $data->image63; $dem=$dem+1; }
if (property_exists($data,"image64")){ 
	$image64= $data->image64; $dem=$dem+1; }
if (property_exists($data,"image65")){ 
	$image65= $data->image65; $dem=$dem+1; }
if (property_exists($data,"image66")){ 
	$image66= $data->image66; $dem=$dem+1; }
if (property_exists($data,"image67")){ 
	$image67= $data->image67; $dem=$dem+1; }
if (property_exists($data,"image68")){ 
	$image68= $data->image68; $dem=$dem+1; }
if (property_exists($data,"image69")){ 
	$image69= $data->image69; $dem=$dem+1; }
if (property_exists($data,"image70")){ 
	$image70= $data->image70; $dem=$dem+1; }
if (property_exists($data,"image71")){ 
	$image71= $data->image71; $dem=$dem+1; }
if (property_exists($data,"image72")){ 
	$image72= $data->image72; $dem=$dem+1; }
if (property_exists($data,"image73")){ 
	$image73= $data->image73; $dem=$dem+1; }
if (property_exists($data,"image74")){ 
	$image74= $data->image74; $dem=$dem+1; }
if (property_exists($data,"image75")){ 
	$image75= $data->image75; $dem=$dem+1; }
if (property_exists($data,"image76")){ 
	$image76= $data->image76; $dem=$dem+1; }
if (property_exists($data,"image77")){ 
	$image77= $data->image77; $dem=$dem+1; }
if (property_exists($data,"image78")){ 
	$image78= $data->image78; $dem=$dem+1; }
if (property_exists($data,"image79")){ 
	$image79= $data->image79; $dem=$dem+1; }
if (property_exists($data,"image80")){ 
	$image80= $data->image80; $dem=$dem+1; }
if (property_exists($data,"image81")){ 
	$image81= $data->image81; $dem=$dem+1; }
if (property_exists($data,"image82")){ 
	$image82= $data->image82; $dem=$dem+1; }
if (property_exists($data,"image83")){ 
	$image83= $data->image83; $dem=$dem+1; }
if (property_exists($data,"image84")){ 
	$image84= $data->image84; $dem=$dem+1; }
if (property_exists($data,"image85")){ 
	$image85= $data->image85; $dem=$dem+1; }
if (property_exists($data,"image86")){ 
	$image86= $data->image86; $dem=$dem+1; }
if (property_exists($data,"image87")){ 
	$image87= $data->image87; $dem=$dem+1; }
if (property_exists($data,"image88")){ 
	$image88= $data->image88; $dem=$dem+1; }
if (property_exists($data,"image89")){ 
	$image89= $data->image89; $dem=$dem+1; }
if (property_exists($data,"image90")){ 
	$image90= $data->image90; $dem=$dem+1; }
if (property_exists($data,"image91")){ 
	$image91= $data->image91; $dem=$dem+1; }
if (property_exists($data,"image92")){ 
	$image92= $data->image92; $dem=$dem+1; }
if (property_exists($data,"image93")){ 
	$image93= $data->image93; $dem=$dem+1; }
if (property_exists($data,"image94")){ 
	$image94= $data->image94; $dem=$dem+1; }
if (property_exists($data,"image95")){ 
	$image95= $data->image95; $dem=$dem+1; }
if (property_exists($data,"image96")){ 
	$image96= $data->image96; $dem=$dem+1; }
if (property_exists($data,"image97")){
 $image97= $data->image97; $dem=$dem+1; }
if (property_exists($data,"image98")){ 
	$image98= $data->image98; $dem=$dem+1; }
if (property_exists($data,"image99")){
 $image99= $data->image99; $dem=$dem+1; }
if (property_exists($data,"image100")){ 
	$image100= $data->image100; $dem=$dem+1; }
