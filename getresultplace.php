...
$sql = "SELECT * from `place` order by id DESC";
...
<th> Address </th>
                  ...
                  <!-- sửa xóa ảnh, thông tin<th>Manage</th> -->
                </tr>
...
{foreach($faq as $k=>$v) { ?>
                ...
                <tr>
                  ...
                  <?php $area= "SELECT name FROM `area` where id = '".$faq[$k]['areaId']."'";
                  $check=mysqli_query($conn, $area);
  ...
  <!-- <td><a href="viewplace.php?id=<?php echo base64_encode($faq[$k]['id']);?>"><button class=" btn btn-primary" >View <i class="fa fa-eye" aria-hidden="true"></i></button></a></td>     -->
                  ...
                  <td><a href="editplace.php?id=<?php echo base64_encode($faq[$k]['id']);?>"><button class=" btn btn-primary  btn-success" >Sửa <i class="fa fa-pencil" aria-hidden="true"></i></button></a>
