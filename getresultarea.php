...
$paginationlink = "getresultarea.php?page=";	
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"><i class="fa fa-list-ol fa-5" aria-hidden="true"></i>All Area</h3>
  ...
  <table class="table table-hover" id="myTable">
    ...
    ?>
      <tr>
       ...
       <td><?php echo $faq[$k]['country'];?></td>
       <td><?php echo $faq[$k]['climate'];?></td>
       <td><a href="editarea.php?id=<?php echo base64_encode($faq[$k]['id']);?>"><button class=" btn btn-primary btn-warning" >Edit<i class="fa fa-pencil" aria-hidden="true"></i></button></a>
        <td><a href="deletearea.php?id=<?php echo base64_encode($faq[$k]['id']);?>" class="btn btn-social-icon btn-google" onClick="return checkDelete()" ><i class="fa fa fa-trash-o"></i></a>
