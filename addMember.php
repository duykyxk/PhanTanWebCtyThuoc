...
$check=mysqli_query($conn, "select * from `group` where id =".$id."");
...
<section class="content">
  ...
  <div class="row">
    ...
    <section class="col-lg-17 connectedSortable">
      ...
      <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs pull-right">
          <li class="pull-left header"><i class="fa fa-map-marker fa-2" aria-hidden="true"></i>Add member for group "<?=$name?>"</li>
      ...
      <script>
       ...
       function changePagination(option) {
         if(option!= "") {
          getresult("getresultMember.php?id=<?php echo $id;?>");
        }
      }
    </script>
    ...
    <div class="page-content">
     ...
     <div>
      <form action="add-member.php?id=<?php echo base64_encode($id);?>" method="POST">
       <div style="border-bottom: #F0F0F0 1px solid;margin-bottom: 15px;">
       Add member:</div>
